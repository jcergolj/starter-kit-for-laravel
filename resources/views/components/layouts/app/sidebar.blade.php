            ...
            <div class="w-full min-h-screen flex">
                <aside class="hidden lg:flex lg:flex-col max-w-[250px] w-full p-4 space-y-1">
                    ...
                    <div class="space-y-2 mt-6">
                        <span class="text-base-content/50 text-xs px-1">{{ __('Management') }}</span>
                        <x-sidebar.navlist class="px-0">
                            <x-sidebar.navlist-item icon="user-group" :href="route('clients.index')" :current="request()->routeIs('clients.*')">{{ __('Clients') }}</x-sidebar.navlist-item>
                            <x-sidebar.navlist-item icon="briefcase" :href="route('projects.index')" :current="request()->routeIs('projects.*')">{{ __('Projects') }}</x-sidebar.navlist-item>
                        </x-sidebar.navlist>
                    </div>
